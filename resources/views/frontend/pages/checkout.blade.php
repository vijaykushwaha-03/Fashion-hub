                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <!-- <input name="payment_method" type="radio" value="cardpay" id="cardpay" required>
                                                    <label for="cardpay">Card Payment</label><br> -->
...
@push('scripts')
    ...
    <!-- Script to Show/Hide Card Details -->
<script>
    // Get all payment method radio buttons
    const paymentRadios = document.getElementsByName('payment_method');
    const cardDetailsDiv = document.getElementById('creditCardDetails');

    // Add change event listener to all payment method radios
    paymentRadios.forEach(radio => {
        radio.addEventListener('change', function () {
            if (this.value === 'cardpay' && this.checked) {
